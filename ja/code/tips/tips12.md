...
2. あらかじめ定期的に集まる機会をつくっておくことで、各チームメンバーが経験したこと・変化を確実に吸収することができる。
   社会や組織の変化が激しいなか、変化の兆しを感じてからミーティングを開催していると手遅れになります。定期開催することで、前回のミーティングから今回のミーティングまでの差分をキャッチアップする機会が保証できるようになるのです。これによって、プロジェクトのゴールやマイルストーンをみんなで納得して変化させることも可能になります。
